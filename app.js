...
document.getElementById("risultato").innerHTML="Seleziona colleghi";

return;

}

const {sequenza}=trovaRotazione(presenti);
...
document.getElementById("risultato").innerHTML="❌ Guidatore sbloccato";
